...
var (
	...
	flagPullRequestCopy,
	flagPullRequestEdit,
	flagPullRequestMaintainerModify,
	flagPullRequestPush,
...
func init() {
	...
	cmdPullRequest.Flag.BoolVarP(&flagPullRequestMaintainerModify, "restrict-maintainer-modify", "R", true, "RESTRICT-MAINTAINER-MODIFY")
...
func pullRequest(cmd *Command, args *Args) {
	...
	switch mm {
	case "", "true":
		// flagPullRequestMaintainerModify overwrites hub.maintainerModify
		maintainerModify = flagPullRequestMaintainerModify
	case "false":
		maintainerModify = false
	default:
		utils.Check(fmt.Errorf("Invalid value for hub.maintainerModify. `true` or `flase` is a acceptable value."))
	}
